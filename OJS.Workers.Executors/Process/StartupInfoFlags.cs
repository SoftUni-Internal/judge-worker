namespace OJS.Workers.Executors.Process
{
    public enum StartupInfoFlags
    {
        ...
        /// </summary>
        StartfForceonfeedback = 0x00000040,
        ...
        /// </summary>
        StartfPreventpinning = 0x00002000,
        ...
        /// </summary>
        StartfRunfullscreen = 0x00000020,
